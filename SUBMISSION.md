...
- **Demo access code:** _filled in on the Devpost form — deliberately not in the public repo_
- **Video:** _pending_
...
> https://firstframe.migarci2.dev/app), enter the access code from this submission, and you
...
- [x] Live URL with preloaded data and a "New spot" button that costs the judges nothing
      (`GEN_MODE=free` with a warm keyframe corpus). Access code supplied on the Devpost form only. Tested from incognito.
